...
to [Booch et al. (2005)] for an elaborate discussion.
...
Note, while [Gemma et al. (1994)] use an Object-Oriented approach to implement the strategies, but we find it more straight-forward and easier-to-read-code to take a functional approach here.
...
Instead, we opt to illustrate its relevance in practice. This leads us to ingredient (iii): Some detail on financial terms used in academia and practice, that help us to describe the problem we chose to solve.
...
Having made good progress, we are finally in a position to work on ingredient (iv), namely, to implement these pricing equations in a Python program using the `Strategy Pattern`.
...
## Yet more financial theory: Are the European options priced fair?
...
<!-- spell-check-ignore -->
- [Gamma al. (1994)]: Gamma, E., Helm, R., Johnson, R., & Vlissides, J. *Design patterns: Elements of reusable object-oriented software.* Addison-Wesley, 1994.
- [Shreve (2004)]: Shreve, S. *Stochastic Calculus for Finance II: Continuous-Time Models.* Springer Finance, 2004.
- [Booch (2005)]: Booch, G., Rumbaugh, J., and Jacobson, I. *The Unified Modeling Language User Guide.* 2nd ed. Addison-Wesley, 2005.
